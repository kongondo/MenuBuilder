...
$(document).ready(function() {
  ...
  if ($.isFunction($(document).on)) $(document).on("click", ".remove_row", removeTr);
  else $(".remove_row").live("click", removeTr);
  ...
  if ($.isFunction($(document).on)) $(document).on("click", ".remove_menu", removeMenu);
  else $(".remove_menu").live("click", removeMenu);
  ...
  // language selector
  $(
    "div#menu_sortable_wrapper"
  ).on("click", "span.menu_language_selector", function() {
    $(this)
      .siblings(".menu_language_selector")
      .removeClass("menu_language_active");
...
// for modified InputfieldPageListSelectMultiple::render => hide children and level inputs if selected item/page is 'Home'
$(document).on("click", "li.PageListActionSelect a", function() {
  var div = $(this).closest("div.PageListItem");
...
// for modified InputfieldAsmSelect::render => hide children and level inputs if selected item/page is 'Home'
$(document).on("change", "select.asmSelect", function() {
  var opt = $(this).children('option[value="1"]');
  var rel = null;
  if (opt.length) {
